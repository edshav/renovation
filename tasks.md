...
- [ ] **Task 2.2: Implement OpenGraph (OG) Social Tags**
...
- [ ] **Task 2.3: Add Image `alt` Attributes**
...
- [ ] **Task 3.1: Normalise Mobile Paddings**
...
- [ ] **Task 3.2: Optimize Render-Blocking Assets**
...
- [ ] **Task 3.3: Centralize Contact Data (Optional)**
